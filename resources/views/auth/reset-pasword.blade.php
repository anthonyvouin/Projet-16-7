            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('password.update') }}" method="post">@csrf
                        ...
                        <input type="hidden" name="token" value="{{ request()->route('token') }}" ><div class="form-group row mb-0">

                        <div class="col-md-6 offset-md-4">
                            <button type="submit" class="btn btn-danger">Créer votre nouveau mot de passe</button>
