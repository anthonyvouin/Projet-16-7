...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <h3 class="text-center">Gérer les catégories enfants</h3>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('childcategory.edit', [$childcategory->id]) }}"><button class="btn btn-sm btn-info">
                                                    ...
                                                    <form action="{{ route('childcategory.destroy', $childcategory->id) }}" method="post">@csrf
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p> Êtes-vous sûr de bien vouloir supprimer cet élément ?
                                                                </p>
                                    ...
                                    @empty
                                    <td>Aucune catégorie enfant à afficher</td>
                                    @endforelse
