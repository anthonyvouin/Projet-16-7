...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/iowxf4s2i6qrp4ct8v34cn48y9zh77z56yg19y5sqn5f72nl/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    <script src="https://cdn.tiny.cloud/1/iowxf4s2i6qrp4ct8v34cn48y9zh77z56yg19y5sqn5f72nl/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ url('ads') }}">
                                    {{ __('Annonces') }}
                                </a> <a class="dropdown-item" href="{{ url('messages') }}">
                                    {{ __('Messages') }}
                                </a>
            ...
            <div class=" collapse navbar-collapse" id="navbarHover">
                ...
                <ul class="container-fluid navbar-nav" id="slider-i">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle text-dark" href="{{route('category.show',$menuItem->slug)}}" data-toggle="dropdown_remove_dropdown_class_for_clickable_link" arial-haspopup="true" arial-expanded="false">
                            {{$menuItem->name}}
