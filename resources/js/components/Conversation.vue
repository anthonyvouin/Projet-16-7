        ...
        <div class="col-md-2">
           <p v-for="(user,index) in users" :key="index">
                <span v-if="user.avatar">
                    <img :src=" '/storage/'+ (user.avatar.substring(7)) " width="80" style="border-radius:20%;">
                </span>
                <span v-else>
                    <img :src=" '/img/man.jpg' " width="80" style="border-radius:20%;">
                </span>
        ...
        <div class="col-md-10">
            <div class="card">
                    ...
                    > 
                        ...
                        <li class="sender clearfix" v-if="message.selfOwned">
                            <span class="chat-img left clearfix mx-2" v-if="message.user.avatar">
                                <img :src=" '/storage/'+ (message.user.avatar.substring(7)) " width="80" style="border-radius:20%;">
                ...
                <div style="min-height: 250px;" v-else>
                    <p class="text-center">Merci de sélectionner un utilisateur dans le chat</p>
                </div>
                ...
                <div class="card-footer">
                    <div class="input-group">
                        <input
                            ...
                            placeholder="Merci d ecrire votre message"
                        />
...
export default {
    ...
    methods:{
        ...
        {
              if(this.body==''){
                alert('Merci d ecrire votre message')
                return
            }

            if(this.selectedUserId==''){
             alert('Merci de séléctionner un utilisateur')
                return   
            }
