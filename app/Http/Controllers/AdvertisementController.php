...
class AdvertisementController extends Controller
{
    ...
    public function store(AdsFormRequest $request)
    {
        ...
        return redirect()->route('ads.index')->with('message', 'Bien créer');
    }
    ...
    { {
            ...
            $ad->update($data);
            return redirect()->route('ads.index')->with('message', 'Bien mis à jour');
        }
    }
    /**
    ...
    public function destroy($id)
    {
        $ad = Advertisement::find($id);
        $ad->delete();
        return back()->with('message', 'L annonce est bien supprimée');
    }
