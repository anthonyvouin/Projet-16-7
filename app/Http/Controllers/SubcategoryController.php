...
class SubcategoryController extends Controller
{
    ...
    public function store(SubCategoryFormRequest $request)
    {
        ...
        return back()->with('message', 'Sous-catégorie créer');
    }
    ...
    public function update(SubcategoryUpdateRequest $request, $id)
    {
        ...
        return redirect()->route('subcategory.index')->with('message', 'Sous-catégrie mis à jour');
    ...
    public function destroy($id)
    {
        ...
        return back()->with('message', 'Sous-catégorie supprimer');
    }
}
